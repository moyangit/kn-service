...
public class EmailController {
	...
	public void sendBatchEmail(@PathVariable Integer minId, @PathVariable Integer maxId) {
			...
			public void run() {
				...
				for (EmailUser emailUser : emailUserList) {
				    ...
				    String html = "<html>" +
				            ...
				            "  <p>一键解锁流媒体</p>" +
				            "  <p>遍布全球的高速服务器</p>" +
				            "  <p>官网网址：<a href='https://knjs.com'>https://knjs.com</a></p>" +
				            "  <p>安卓：<a href='https://down.knsj.xyz/down/ad'>https://down.knsj.xyz/down/ad(若无法打开，复制到浏览器打开)</a></p>" +
				            "  <p>windows：<a href='https://down.knsj.xyz/down/pc'>https://down.knsj.xyz/down/pc(若无法打开，复制到浏览器打开)</a></p>" +
				            "  <p>mac：<a href='https://down.knsj.xyz/down/mac'>https://down.knsj.xyz/down/mac(若无法打开，复制到浏览器打开)</a></p>" +
				            "  <p>苹果：<a href='https://user.kuainiaojsq.xyz/page/subscribe.html'>https://user.kuainiaojsq.xyz/page/subscribe.html(若无法打开，复制到浏览器打开)</a></p>" +
