...
public class PathV2Controller {
	...
	public Response<?> defaultPath(boolean global, String dType, String dId, boolean isEncrypt) {
		...
		Map<String, Object> result = pathService.getPathByCodeV2(PathCodeEnum.HK.name(), userId, !global, dType, dId, isEncrypt);
	...
	public Response<?> getPathByCode(@PathVariable String code, boolean global, String dType, String dId, boolean isEncrypt) {
		...
		Map<String, Object> result = pathService.getPathByCodeV2(code, userId, !global, dType, dId,isEncrypt);
		return Response.ok(result);
	}
